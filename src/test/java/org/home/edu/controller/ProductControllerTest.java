package org.home.edu.controller;
...
public class ProductControllerTest {
    ...
    public void testGetProductById() throws Exception {
        //Arrange
        Product product = new Product("P1234", "iPhone 6s", new BigDecimal(500));
        //Act & Assert
        this.mockMvc.perform(get("/market/product")
                .param("id", "P1234"))
                .andExpect(model().attributeExists("product"))
                .andExpect(model().attribute("product", new Matcher<Product>() {
                    @Override
                    ...
                    public boolean matches(Object item) {
                        return ((Product) item).getProductId().equals(product.getProductId());
                    }
